...
Public Class Assetassignment2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssetInventorySystem.Assetassignment2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAssetassignment2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Assetassignment2 = New Assetassignment2()
        rpt.Site = Me.Site
        Return rpt
    End Function
